...
<xsl:template match="/rss">
	...
	<link rel="canonical" href="http://localhost:4000/essai_ON/assets/xslt/rss.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="RSS Feed (Styled)">
	<meta property="og:description" content="Ocean Next: Hydrosphere Data and Numerics">
	<meta property="og:url" content="http://localhost:4000/essai_ON/assets/xslt/rss.xslt">
