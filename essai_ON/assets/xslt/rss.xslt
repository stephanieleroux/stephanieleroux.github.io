...
<xsl:template match="/rss">
	...
	<link rel="canonical" href="https://stephanieleroux.github.io/essai_ON/assets/xslt/rss.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="RSS Feed (Styled)">
	<meta property="og:description" content="Ocean Next: Hydrosphere Data and Numerics">
	<meta property="og:url" content="https://stephanieleroux.github.io/essai_ON/assets/xslt/rss.xslt">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="https://stephanieleroux.github.io/essai_ON/temp/">News</a></li>
              <li class="divider"></li>
